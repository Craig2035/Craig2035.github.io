...
1.	Tailoring a revised customer loyalty programme with targeted marketing
2.	Automation of marketing emails for customer engagement
3.	Better identification of top selling products for marketing
...
{% include figure image_path="/assets/images/turtle1.png" alt="Turtle image" caption="#Cluster 0 in red (top right) show the highest value customers#" %}
...
{% include figure image_path="/assets/images/turtle2.png" alt="Turtle2 image" caption="*Larger words have a higher frequency of use*" %}
...
1.	Train sales and customer service teams/implementation of new customer loyalty programme and survey.
2.	Further CRM analysis 
3.	Measure email open and click rate for customer offers
